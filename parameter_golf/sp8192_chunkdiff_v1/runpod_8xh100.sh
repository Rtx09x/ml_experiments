...
keys = [
    ...
    "SPARSE_END_STEP", "SPARSE_EVERY", "SPARSE_INCLUDE", "CHUNKDIFF_ENABLED", "CHUNKDIFF_WEIGHT", "CHUNKDIFF_CHUNK_SIZE", "CHUNKDIFF_MASK_MIN", "CHUNKDIFF_MASK_MAX", "CHUNKDIFF_EVERY", "CHUNKDIFF_MIN_STEP", "COMPRESSOR",
