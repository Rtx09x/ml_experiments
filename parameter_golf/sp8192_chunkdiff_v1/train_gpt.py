	...
	def step_fn(step,lr_scale):
		...
		for micro_step in range(h.grad_accum_steps):
			...
			with torch.autocast(device_type='cuda',dtype=torch.bfloat16,enabled=True):
				...
				chunkdiff_loss=base_model.chunkdiff_loss(x,h.chunkdiff_chunk_size,h.chunkdiff_mask_min,h.chunkdiff_mask_max) if use_chunkdiff else ar_loss.new_zeros(())
