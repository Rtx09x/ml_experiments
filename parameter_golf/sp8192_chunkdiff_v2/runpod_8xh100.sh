...
EXPERIMENT_DIR="${EXPERIMENT_REPO_DIR}/parameter_golf/sp8192_chunkdiff_v2"
RUN_ID="${RUN_ID:-sp8192_chunkdiff_v2_8xh100}"
RUN_ROOT="${RUN_ROOT:-${WORKSPACE_ROOT}/sp8192_chunkdiff_v2_runs}"
...
mkdir -p "${PARAMETER_GOLF_DIR}/working/sp8192_chunkdiff_v2"
cp "${EXPERIMENT_DIR}/train_gpt.py" "${PARAMETER_GOLF_DIR}/working/sp8192_chunkdiff_v2/train_gpt.py"
cp "${EXPERIMENT_DIR}/README.md" "${PARAMETER_GOLF_DIR}/working/sp8192_chunkdiff_v2/README.md"
cp "${EXPERIMENT_DIR}/runpod_8xh100.sh" "${PARAMETER_GOLF_DIR}/working/sp8192_chunkdiff_v2/runpod_8xh100.sh"
...
export CHUNKDIFF_SEQ_LEN="${CHUNKDIFF_SEQ_LEN:-256}"
...
set +e
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE:-8}" working/sp8192_chunkdiff_v2/train_gpt.py 2>&1 | tee "${LOG_PATH}"
