...
def main() -> None:
    if len(sys.argv) == 4:
        ...
        (run_dir / "train.log").write_text(
            "\n".join(
                [
                    "step:50/20000 train_loss:3.2100 blockdiff_loss:3.9000 train_time:12000ms step_avg:240.00ms tok/s:270000 progress:0.4% eta:49.1m",
                    "sparsity:final target:0.300 actual:0.301 include:mlp,attn",
