...
EXPERIMENT_DIR="${EXPERIMENT_REPO_DIR}/parameter_golf/sp8192_top_sparse_100m"
RUN_ID="${RUN_ID:-sp8192_top_sparse_100m_1xh100_80m}"
RUN_ROOT="${RUN_ROOT:-${WORKSPACE_ROOT}/sp8192_top_sparse_100m_runs}"
...
mkdir -p "${PARAMETER_GOLF_DIR}/working/sp8192_top_sparse_100m"
cp "${EXPERIMENT_DIR}/train_gpt.py" "${PARAMETER_GOLF_DIR}/working/sp8192_top_sparse_100m/train_gpt.py"
cp "${EXPERIMENT_DIR}/README.md" "${PARAMETER_GOLF_DIR}/working/sp8192_top_sparse_100m/README.md"
cp "${EXPERIMENT_DIR}/runpod_1xh100_80m.sh" "${PARAMETER_GOLF_DIR}/working/sp8192_top_sparse_100m/runpod_1xh100_80m.sh"
...
set +e
torchrun --standalone --nproc_per_node=1 working/sp8192_top_sparse_100m/train_gpt.py 2>&1 | tee "${LOG_PATH}"
